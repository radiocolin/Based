...
struct TeamColorProvider {
    private static let teamColors: [String: UIColor] = [
        ...
        "Cleveland Guardians": UIColor(red: 0.89, green: 0.10, blue: 0.22, alpha: 1.0),
        "Colorado Rockies": UIColor(red: 0.42, green: 0.29, blue: 0.63, alpha: 1.0),
        "Detroit Tigers": UIColor(red: 0.98, green: 0.27, blue: 0.09, alpha: 1.0),
        "Houston Astros": UIColor(red: 0.92, green: 0.43, blue: 0.12, alpha: 1.0),
        ...
        "Milwaukee Brewers": UIColor(red: 1.0, green: 0.77, blue: 0.18, alpha: 1.0),
        ...
        "Tampa Bay Rays": UIColor(red: 0.56, green: 0.74, blue: 0.90, alpha: 1.0),
